...
const UserManager = () => {
    ...
    const fetchDevices = async () => {
        try {
            ...
            const availableDevices = response.data.filter(device => !device.userId);
    ...
    const updateUser = async () => {
        try {
            const response = await axios.put(`http://users.localhost/api/users/${editingUser.id}`, user);
    ...
    const assignDeviceToUser = async () => {
        ...
        try {
            const response = await axios.post('http://devices.localhost/api/devices/assign', {
