...
const UserManager = () => {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/users/roleUser');
    ...
    const updateUser = async () => {
        try {
            const response = await axios.put(`http://localhost:8080/api/users/${editingUser.id}`, user);
    ...
    const assignDeviceToUser = async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:8081/api/devices/assign`, {
